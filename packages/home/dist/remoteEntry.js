...
var moduleMap = {
	"ProductCarousel": () => {
		return __webpack_require__.e("src_ProductCarousel_jsx").then(() => () => __webpack_require__(/*! ./src/ProductCarousel */ "./src/ProductCarousel.jsx"));
	}
};
var get = (module) => {
	return (
...
/******/ 	return __webpack_require__("?9cc2");
/******/ })()
;
